<br>
<p align="center"><img src="img/bash.png" width="200px"></p>
<br>

<h1 align="center"> Bash Bible </h1>
...
```shell
$ urlencode "https://github.com/AlexRoman777/Linux"
https%3A%2F%2Fgithub.com%2FAlexRoman777%2FLinux
```
...
```shell
$ urldecode "https%3A%2F%2Fgithub.com%2FAlexRoman777%2FLinux"
https://github.com/AlexRoman777/Linux
```
...
Traps allow a script to execute code on various signals. Traps are used to redraw the user interface on window resize. Another use case is cleaning up temporary files on script exit.
...
If unicode is not required, it can be disabled for a performance increase. Results may vary however there have been noticeable improvements.
